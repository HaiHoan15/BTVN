...
<div class="auth-container">
    <div class="auth-header">
        ...
        <p class="auth-subtitle">Tạo tài khoản mới để mua sắm tại Shop Ngường Giủ</p>
    </div>
    ...
    <form method="POST" action="/webbanhang/Account/store">
        ...
        <div class="form-row">
            <div class="form-group">
                <label class="form-label">Số điện thoại <span class="form-label-optional">(tùy chọn)</span></label>
                <input type="text" name="phone" class="form-control" placeholder="0912345678">
            </div>
            <div class="form-group">
                <label class="form-label">Địa chỉ <span class="form-label-optional">(tùy chọn)</span></label>
...
<script>
    ...
    <?php if (isset($_GET['error']) && $_GET['error'] == 'password'): ?>
        showError('Lỗi', 'Mật khẩu xác nhận không khớp. Vui lòng thử lại.');
    <?php endif; ?>

    <?php if (isset($_GET['error']) && $_GET['error'] == 'username'): ?>
        showError('Lỗi', 'Tên tài khoản này đã tồn tại. Vui lòng chọn tên khác.');
    <?php endif; ?>

    <?php if (isset($_GET['error']) && $_GET['error'] == 'email'): ?>
        showError('Lỗi', 'Email này đã được sử dụng. Vui lòng sử dụng email khác.');
    <?php endif; ?>
</script>
